...
const ThemeSwitcher = () => {
  ...
  return (
    <div class="relative inline-block text-left">
      <div>
        <button onClick={() => setIsOpen(!isOpen)} type="button" id="menu-button" aria-expanded="true" aria-haspopup="true" class="flex justify-center items-center gap-2 w-full rounded-md border-none px-4 py-2 dark:bg-secondary-100 dark:text-white text-sm font-medium dark:hover:bg-secondary-200 transition-colors focus:outline-none focus:bg-secondary-900 dark:focus:bg-secondary-200 bg-white hover:bg-secondary-900 text-secondary-300">
          Theme
